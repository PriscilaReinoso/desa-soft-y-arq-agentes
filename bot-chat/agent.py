...
MCP_SERVER_SCRIPT = MCP_SERVER_DIR / "src" / "server.py"
...
def _mcp_python() -> str:
    ...
    candidates = [
        ...
        MCP_SERVER_DIR / "src" / "venv" / "Scripts" / "python.exe",
    ]
...
async def ventas_ferreteria_agent(state: AgentState):
    ...
    # Las herramientas MCP son asincronas y compatibles con bind_tools
...
# --- Funcion publica para chat.py ---

async def responder_agent(question: str, history: list) -> str:
    """Punto de entrada desde chat.py. Recibe pregunta + historial y devuelve respuesta."""
    messages = []
