...
El sistema MUST incluir la definición de servicios en `docker-compose.yml` para ejecutar PostgreSQL 16 Alpine expuesto en el puerto 5432 con credenciales de desarrollo.
...
El sistema MUST incluir un script `docker/init.sql` que se monte en `/docker-entrypoint-initdb.d/` para crear la estructura de tablas e insertar datos iniciales de ferretería en el primer arranque.
